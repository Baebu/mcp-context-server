...
// Mock semantic extension for testing
...
async function testSemanticFeatures() {
  ...
  try {
    ...
    // Create semantic extension (using test version)
    const semanticDb = new TestSemanticExtension(db);
    ...
    db.close();
    console.log('✅ Semantic functionality test completed successfully!');
