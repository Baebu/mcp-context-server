...
try {
    ...
    `);
        stmt.run('test:phase2:migration-test', JSON.stringify({ test: 'Phase 2 migration test' }), 'test', JSON.stringify([0.1, 0.2, 0.3]), JSON.stringify(['phase2', 'migration', 'test']), 'test');
